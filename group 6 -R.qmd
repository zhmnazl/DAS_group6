---
title: " Data Analysis Skills: Example Report"
...
write.csv(data6,"data4.csv",row.names=FALSE)
...
data6 |>
   summarize('articles.Mean' = mean(articles),
             ...
             'ES.sd' = sd(ES),
             .by = levels) |>
 arrange(factor(levels, levels = c("high", "moderate", "low"), ordered = TRUE)) |>
 gt() |> 
...
ggplot(data, aes(x = ES, y = articles, color = levels)) +
  geom_point() +
